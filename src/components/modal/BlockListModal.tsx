...
function UserNickname({ nickname }: Props) {
  return <div className="w-full text-base tracking-wider font-bold">{nickname}</div>;
}

export default function BlockListModal() {
  return (
    <FlexBox direction="col" className="w-[300px] h-[300px] gap-6 p-6 bg-gray-600">
      <div className="w-full border-solid border-b text-base tracking-wider font-bold">
        Blocked User List
      </div>
      <FlexBox direction="col" className="w-full gap-3 overflow-auto">
