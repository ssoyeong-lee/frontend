      ...
      <FlexBox direction="col" className="w-full h-full gap-6">
        <FlexBox className="w-full justify-between">
          ...
          <FlexBox className="gap-3">
            <div>user121</div>
            <Icon src="/icon/unselectedBlock.png" onClick={blockClick} className="w-6 h-6" alt="name"/>
            <Icon src="/icon/unselectedSetting.png" onClick={settingClick} className="w-6 h-6" alt="name"/>
          </FlexBox>
        </FlexBox>
        <Divider />
        <ChatDisplay />
